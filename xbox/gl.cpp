...
void nglDisplay()
{
	...
	if (SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_LEFTY) < -DEAD_ZONE || SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_DPAD_UP)) pad_game[0] = 1;
	else if (SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_LEFTY) > DEAD_ZONE || SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_DPAD_DOWN)) pad_game[0] = 2;
	else pad_game[0] = 0;

	if (SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_LEFTX) < -DEAD_ZONE || SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_RIGHTX) < -DEAD_ZONE || SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_DPAD_LEFT)) pad_game[1] = 1;
	else if (SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_LEFTX) > DEAD_ZONE || SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_RIGHTX) > DEAD_ZONE || SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_DPAD_RIGHT)) pad_game[1] = 2;
	else pad_game[1] = 0;
	
	if (SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_RIGHTY) < -DEAD_ZONE) pad_game[2] = 1;
	else if (SDL_GameControllerGetAxis(pad, SDL_CONTROLLER_AXIS_RIGHTY) > DEAD_ZONE) pad_game[2] = 2;
	else pad_game[2] = 0;

	if (SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_A)) pad_game[8] = 1;
	if (SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_B)) pad_game[9] = 1;
	
	if (SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_X)) pad_game[10] = 1;
	
	if (SDL_GameControllerGetButton(pad, SDL_CONTROLLER_BUTTON_START)) pad_game[11] = 1;
