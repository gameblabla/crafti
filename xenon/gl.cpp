...
static inline void * memset_16bit(void *dest, const uint16_t val, size_t len)
{
...
{
	memset_16bit(screen, color,SCREEN_WIDTH*SCREEN_HEIGHT);
	memset_16bit(z_buffer, UINT16_MAX,SCREEN_WIDTH*SCREEN_HEIGHT);
